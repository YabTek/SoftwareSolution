...
const FirstScreen = () => {
    ...
    return(
        <>
        <div style={{display:"flex",width:"auto",flexDirection:"row",backgroundColor:"rgba(240, 222, 0, 1)",padding:"40px 40px 80px 40px",justifyContent:"center",alignItems:"center"}}>
            ...
            <div >
                <img className="FirstScreenImg" src={FirstScreenImage} alt="" />
            </div>
